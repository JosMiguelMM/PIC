...
#include <KBD18F.c>
//#include <DS1307.c>
#ROM     0xf00002={0x4523}     //colocar 0 para usuario 1, estan al reves primero esta los dos digitos ultimos y luego los otros
#ROM     0xf00004={0x5634}     //esto es asignacion de claves para los usuarios
#define SW PIN A5
...
admin: 
      ...
      delay_ms(3000);
       ...
       //bienvenidos al menu del diseñador
